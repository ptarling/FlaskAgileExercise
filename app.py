...
app.config['MONGO_URI'] = 'mongodb+srv://admin:admin1@cluster0-bzusf.mongodb.net/foodb?retryWrites=true&w=majority'

app.config['SECRET_KEY'] = '23dfwdsfsd6L6SAfy4MDtAxpdz1bKtO37H728'
